...
export default function AdminCities() {
  ...
  const { getRangesCitiesLocal} = UseAdminRangeCities()
  ...
  const handleGetAllRangesCities = async () => {
    ...
    setRangeCitiesLocal(getAllCities ? getAllCities : [])
    setFilteredCities(getAllCities ? getAllCities :[])
  }

  const handleSearch = (text) => {
    if (!text || !rangeCitiesLocal?.length) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.cityContainer}>
        <View style={styles.leftContainer}>
          <Text style={styles.cityLegend}>Listado de Municipios</Text>
        </View>
